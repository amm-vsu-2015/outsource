...
import edu.core.java.print.loader.FeedLoader;
import edu.core.java.print.loader.KitsLoader;
import edu.core.java.print.repository.FeedRepository;
import edu.core.java.print.repository.KitsRepository;
import edu.core.java.print.shared.ApplicationProperties;
import edu.core.java.print.translator.FeedTranslator;
import edu.core.java.print.translator.KitsTranslator;
...
public class Main {
    ...
    // javac -d out src/main/java/edu/core/java/print/Main.java
    // out
    // jar cmvf ../src/main/resources/META-INF/manifest.mf ../out/rb.jar edu/core/java/print/Main.class
    // cd ..
    // java -jar ./out/rb.jar
    public static void main(String[] args) {
        Logger logger = LoggerFactory.getLogger("edu.core.java.print.Main");
